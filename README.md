The main game will run locally and nothing needs to be downloaded or installed to work, some of the tests will run locally, but others will need to be run from a website.
